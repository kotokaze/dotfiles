...
alias imgcat=${LOCALOPT}/iterm2/imgcat;alias imgls=${LOCALOPT}/iterm2/imgls;alias it2api=${LOCALOPT}/iterm2/it2api;alias it2attention=${LOCALOPT}/iterm2/it2attention;alias it2check=${LOCALOPT}/iterm2/it2check;alias it2copy=${LOCALOPT}/iterm2/it2copy;alias it2dl=${LOCALOPT}/iterm2/it2dl;alias it2getvar=${LOCALOPT}/iterm2/it2getvar;alias it2git=${LOCALOPT}/iterm2/it2git;alias it2setcolor=${LOCALOPT}/iterm2/it2setcolor;alias it2setkeylabel=${LOCALOPT}/iterm2/it2setkeylabel;alias it2tip=${LOCALOPT}/iterm2/it2tip;alias it2ul=${LOCALOPT}/iterm2/it2ul;alias it2universion=${LOCALOPT}/iterm2/it2universion;alias it2profile=${LOCALOPT}/iterm2/it2profile
