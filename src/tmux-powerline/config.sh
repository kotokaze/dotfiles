...
# macos_notification_count.sh {
	...
	# sqlite3 -list "/var/folders/3l/dtdmjxr50wdg9p0y4xcwqnhr0000gn/0//com.apple.notificationcenter/db/db" 'select * from app_info'
...
# mailcount.sh {
	...
	export TMUX_POWERLINE_SEG_MAILCOUNT_MAILDIR_INBOX="/Users/kotokaze/.mail/inbox/new"
	...
	export TMUX_POWERLINE_SEG_MAILCOUNT_MAILCHECKRC="/Users/kotokaze/.mailcheckrc"
# }
